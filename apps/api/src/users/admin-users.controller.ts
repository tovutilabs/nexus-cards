...
import { UpdateUserRoleDto, UpdateUserSubscriptionDto } from './dto/admin-user.dto';
...
export class AdminUsersController {
  ...
  async updateUserSubscription(
    ...
    return this.usersService.updateUserSubscription(userId, updateSubscriptionDto);
  }

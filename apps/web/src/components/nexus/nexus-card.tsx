...
const nexusCardVariants = cva('transition-all duration-200 border-border', {
  variants: {
    variant: {
      ...
      gradient:
        'bg-gradient-to-br from-nexus-blue-50 to-nexus-blue-100 dark:from-nexus-blue-950 dark:to-nexus-blue-900',
      glass:
        'bg-white/80 dark:bg-black/40 backdrop-blur-md shadow-lg border border-white/20',
    },
    hover: {
      none: '',
...
const NexusCard = React.forwardRef<HTMLDivElement, NexusCardProps>(
  (
    ...
    return (
      <Card
        className={cn(nexusCardVariants({ variant, hover, className }))}
        ref={ref}
        {...props}
      >
